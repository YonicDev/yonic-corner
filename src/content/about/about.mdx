...
import UnderConstruction from "@assets/articles/about/under_construction.webp"
...
* **Categories:** Pretty much what it says on the in. Every article belongs to one.
* **Tags:** Very useful for specific searches. Most articles have more than one.
...
Since they're vector images, they show up at any display scale and keep the maximum visual quality,
no matter how big they are and how much you zoom.

By the way, if you put your cursor over the characters on your PC, or hold your finger on them,
...
<figure style="text-align: center;">
    <Image style="width: auto; height: auto;" src={UnderConstruction.src} alt="Under construction" width={UnderConstruction.width} height={UnderConstruction.height} />
    <figcaption>
        Another classic relic: An under construction sign.
        This one makes sense, though, since there are some features that still need to be worked on.
    </figcaption>
</figure>