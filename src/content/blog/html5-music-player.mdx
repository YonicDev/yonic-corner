...
updatedDate: '2023-08-02T19:36:43.988Z'
...
pulls in the information from a list of songs.

```astro
// src/pages/player/[song].astro
---
// SongList is an Record<string, Song> object.
...
const { song: songId } = Astro.params;
...
You can also add all the metadata you want inside that list.
...
<PlayerLink id="rhythm-heaven_remix4" />
