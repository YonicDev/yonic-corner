...
Although for this design, I did not restrain myself from using the
modern CSS, I'm working on a way to expand the compatibility to
older browsers (and maybe, hopefully, IE, the mecca for old web browsing).
...
developer experience in Astro than Hugo, and also to allow for a little bit of CSR,
...
<figure>
    <Image src={HugoVersion} alt="The Yonic Corner: Hugo version" width={768} />
    <figcaption>
...
- The **music player** is not ready. I promise, I'll make it work without JavaScript, like before.
But I don't discard the possibility of making a JavaScript one.
