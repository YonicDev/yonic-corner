...
import Hunters1 from "@lib/assets/articles/need-prime-hunters-remake/hunters-screenshot.png"
import HuntersLicense from "@lib/assets/articles/need-prime-hunters-remake/license.jpg"
import HuntersSylux from "@lib/assets/articles/need-prime-hunters-remake/sylux.webp"
...
<figure>
    <Image src={Hunters1} alt="Metroid Prime: Hunters screenshot" width={768} />
    <figcaption>
...
<TextBubble position="bottom" alignment="far" theme="yonic">
    ...
    <Image src={HuntersLicense} alt="Metroid Prime: Hunters maximum possible license" width={624} style="width: 100%" />
</TextBubble>
...
<figure>
    <Image src={HuntersSylux} alt="Sylux" width={768} />
    <figcaption>
