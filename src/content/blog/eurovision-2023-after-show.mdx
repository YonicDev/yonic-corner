...
<Chara name="yonic" set="summer" sprite="thinking-01" thoughts="The dreaded 2nd place in running order has to be a self-fulfilling prophecy... It has to." />
...
<center>
    <figure style="width: 320px; display:inline-block;">
        <Image src={Po} alt="Small Po plushie" width={400} />
        <figcaption>
            Smol Po plushie
        </figcaption>
    </figure>
    <span>vs</span>
    <figure style="width: 320px; display:inline-block;">
        <Image src={TrueWinner} alt="Big Peppa Pig" width={400} />
        <figcaption>
            Big Peppa Pig
        </figcaption>
    </figure>
